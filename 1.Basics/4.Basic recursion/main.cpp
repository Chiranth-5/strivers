...
int main()
{
    ...
    // int sum = obj.sumOffirstNNumbers(4);
    // cout << sum;
    // cout << endl;

    // cout << "5. factorial of first N numbers : ";
    // int factorail = obj.factorialOfGivenNumber(5);
    // cout <<factorail;
    // cout << endl;


    cout << "6. rev An array of first abc is same : ";
    bool value  = obj.revAnArray(0,2,"aba");
    cout << value;
    cout << endl;
